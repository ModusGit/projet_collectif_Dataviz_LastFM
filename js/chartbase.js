...
// Fonction pour rechercher dans un tableau un objet par la valeur de sa propriété 'name'
...
// Fonction pour générer les Bubbles en fonction des données présentes dans les objets récupérés
function getDataSet () {
  let dataSet = []
